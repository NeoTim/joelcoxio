                        ...
                        text: 'Profile',
                            ...
                            onclick: function() {
                                ...
                                editor.windowManager.open( {
                                    ...
                                    onsubmit: function( e ) {
                                        editor.insertContent( '[Profile name="' + e.data.textName1 + '" designation="' + e.data.textName2 + '"]<br/>[Profile_objective]<br/>' + e.data.multilineName1 + '<br/>[/Profile_objective]<br/><br/>[Profile_info][Profile_info_section title="' + e.data.textboxTitle1 +'" desc="' + e.data.textboxName1 + '"][Profile_info_section title="' + e.data.textboxTitle2 +'" desc="' + e.data.textboxName2 + '"][Profile_info_section title="' + e.data.textboxTitle3 +'" desc="' + e.data.textboxName3 + '"][Profile_info_section title="' + e.data.textboxTitle4 +'" desc="' + e.data.textboxName4 + '"][Profile_info_section title="' + e.data.textboxTitle5 +'" desc="' + e.data.textboxName5 + '"][/Profile_info][/Profile]' );
                            ...
                            onclick: function() {
                                ...
                                editor.windowManager.open( {
                                    ...
                                    onsubmit: function( e ) {
                                        ...
                                        editor.insertContent( '[portfolio]<br/>[portfolio_head title="' + e.data.textboxName + '"][portfolio_body][/portfolio]' );
                            ...
                            onclick: function() {
                                ...
                                editor.windowManager.open( {
                                    ...
                                    onsubmit: function( e ) {
                                        ...
                                        editor.insertContent( '[blog]<br/>[blog_head title="' + e.data.textboxName + '"][blog_body][/blog]' );
                            ...
                            onclick: function() {
                                ...
                                editor.windowManager.open( {
                                    ...
                                    onsubmit: function( e ) {
                                        ...
                                        editor.insertContent( '[resume_head title="' + e.data.textboxName + '"]' );
                            ...
                            onclick: function() {
                                ...
                                editor.windowManager.open( {
                                    ...
                                    onsubmit: function( e ) {
                                        ...
                                        editor.insertContent( '[contact title="' + e.data.textboxName + '"]<br/>[contact_head]' + e.data.gmap + '[contact_info  title="' + e.data.contactinfo + '" address="' + e.data.address + '" phone="' + e.data.phone + '" email="' + e.data.email + '"]<br/><br/>[/contact_info]' + e.data.contact + '[/contact]' );
